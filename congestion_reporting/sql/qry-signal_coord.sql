...
SELECT	concat(street,' ',direction) AS main_street,
	...
	round(AVG(CASE WHEN hh IN (15.5,16,16.5,17,17.5,18) THEN tt_average ELSE NULL END),1) AS pm_tt,
	round(length_km/AVG(CASE WHEN hh IN (15.5,16,16.5,17,17.5,18) THEN tt_average ELSE NULL END)*3600.0,1) AS pm_spd
FROM	temp_data
