...
WITH VAR AS (	SELECT 0 as dt1, -- monday
		...
		'2017-04-24'::date as date_start,
		'2017-06-23'::date as date_end)
...
WITH VAR AS (	SELECT 0 as dt1, -- monday
		...
		0 as dt8, -- holidays
		0 as dt9, -- holiday extensions
		'2017-03-20'::date as date_start,
		'2017-04-09'::date as date_end)
