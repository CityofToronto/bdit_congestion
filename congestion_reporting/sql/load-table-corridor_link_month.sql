...
INSERT INTO here_analysis.corridor_link_month (corridor_id, link_dir, dt, month_bin, day_type, hh, tt_avg, tt_med, obs, tt_65, tt_75, tt_85, tt_95, tt_35, tt_25, tt_15, tt_05)
...
WITH VAR AS (	SELECT 
		...
		'2015-01-01'::date as date_start,
		'2017-08-31'::date as date_end)
