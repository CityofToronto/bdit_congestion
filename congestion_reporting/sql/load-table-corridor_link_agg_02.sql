...
WITH VAR AS (	SELECT 
		...
		'2018-04-25'::date as date_start,
		'2018-05-17'::date as date_end)
...
WHERE		A.tx::date >= VAR.date_start 
		...
		AND (	(A.tx::date IN ('2018-04-25','2018-04-26','2018-04-27','2018-05-14','2018-05-15',
					'2018-04-30','2018-05-01','2018-05-02','2018-05-03','2018-05-04',
					'2018-05-07','2018-05-08','2018-05-09','2018-05-10','2018-05-11') AND C.group_id IN (1,2))
			OR
			(A.tx::date IN ('2018-04-30','2018-05-01','2018-05-02','2018-05-03','2018-05-04',
					'2018-05-07','2018-05-08','2018-05-09','2018-05-10','2018-05-11',
					'2018-05-14','2018-05-15','2018-05-16','2018-05-17') AND C.group_id IN (11,12))
		)
