-- refreshes link lengths in corridor_links
...
-- refreshes cumulative length of corridor at each link in corridor_links
UPDATE here_analysis.corridor_links A
...
-- refreshes total number of links for each corridor in corridors
