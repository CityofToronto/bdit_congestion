--Testing using `congestion.segment_links_v2` and `congestion.segments_v2`
--which has 12165 segments and 38817 links
--took 2hr 42min
--returned 72,718,323 rows

CREATE TABLE congestion.speeds_links_30min_v2 AS
...
FROM congestion.segment_links_v2 a
