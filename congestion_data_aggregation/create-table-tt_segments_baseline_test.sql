CREATE TABLE congestion.tt_segments_baseline_test AS 
...
FROM congestion.tt_segments_30min_test
...
SELECT daytime.segment_id, segments_test.length AS seg_length,
overnight.tt_baseline_overnight_all, overnight.tt_baseline_overnight_hc,
segments_test.length / overnight.tt_baseline_overnight_all * 3.6 AS spd_baseline_overnight_all,
segments_test.length / overnight.tt_baseline_overnight_hc * 3.6 AS spd_baseline_overnight_hc,
daytime.tt_baseline_10pct_all, daytime.tt_baseline_10pct_hc,
segments_test.length / daytime.tt_baseline_10pct_all * 3.6 AS spd_baseline_10pct_all,
segments_test.length / daytime.tt_baseline_10pct_hc * 3.6 AS spd_baseline_10pct_hc
FROM daytime 
JOIN overnight USING (segment_id)
JOIN congestion.segments_test USING (segment_id)
